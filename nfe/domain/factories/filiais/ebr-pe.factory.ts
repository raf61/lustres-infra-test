...
export class EbrPeFactory {
    static getRequiredExtras() {
        return [] // Sem extras obrigatórios específicos
    }
    ...
    static build(pedido: any, extras: any = {}, filial: any) {
        ...
        const nbsCode = "114013900"
        const additionalInformation = `Nome: Empresa Brasileira de Raios`
